...
from jp_tool.core.command_label import argv_command_label
from jp_tool.core.env_check import report_to_json, run_env_check
from jp_tool.core.help_text import format_examples
from jp_tool.core.operation_ui import get_session
from jp_tool.core.results import Success
...
class DoctorAction(ActionBase):
    ...
    def bind_cli(self, app: typer.Typer) -> UnitResult:
        def _doctor_cmd() -> None:
            session = get_session()
            command = argv_command_label(default="jp-tool doctor")
