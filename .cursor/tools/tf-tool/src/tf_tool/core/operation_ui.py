...
_PLAIN_ENV: Final[str] = "TF_TOOL_PLAIN"
_FORCE_UI_ENV: Final[str] = "TF_TOOL_UI"
...
class OperationSession:
    ...
    def finish_summary(self) -> None:
        ...
        table = Table(title="tf-tool session summary", show_header=True, header_style="bold")
