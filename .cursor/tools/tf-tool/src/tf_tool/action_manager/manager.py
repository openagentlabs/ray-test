"""Register and invoke tf-tool actions."""
...
class ActionManager:
    ...
    def register(self, action: ActionBase) -> UnitResult:
        """Register an action derived from ``ActionBase``."""
    ...
    def invoke(self, action_name: str, **kwargs: object) -> TextResult:
        """Invoke a registered action by ``action_name``."""
    ...
    def list_actions(self) -> tuple[ActionBase, ...]:
        """Return registered actions sorted by name."""
