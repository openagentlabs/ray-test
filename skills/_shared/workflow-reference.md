...
|----------|----------------------|-------------------------|
| Terraform skill entry | `skills/tf/SKILL.md` | [tf/SKILL.md](../tf/SKILL.md) |
| Terraform workflow (real) | `skills/tf/workflow.md` | [tf/workflow.md](../tf/workflow.md) |
| Terraform commands | `skills/tf/reference.md` | [tf/reference.md](../tf/reference.md) |
