...
**How:** Terraform → **[workflow.md](workflow.md)**. tf-tool → **uv run** + **[card.md](../../.cursor/tools/tf-tool/card.md)** (one job). Shell syntax → **[reference.md](reference.md)** on **RUN** only.
...
| Job | `uv run tf-tool <cmd> …` | Match one **JOB-*** in **[card.md](../../.cursor/tools/tf-tool/card.md)** |
...
1. **Doctor** → **JOB-01a** in **[card.md](../../.cursor/tools/tf-tool/card.md)**
...
2. **Surface** — Registry → tf-tool + **[card.md](../../.cursor/tools/tf-tool/card.md)**. Plan/apply → **workflow.md** + **reference.md** on **RUN**.
