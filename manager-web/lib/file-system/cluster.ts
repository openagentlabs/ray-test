...
import { NativeFileEngine, type FileEngine } from "./io/engine";
import type { BytesResult, TextResult, UnitResult } from "./core/types";
import { TextEncoding, type TextEncoding as TextEncodingValue } from "./domain/enums";
import {
  validateBytesWrite,
  validatePath,
  validateTextWrite,
} from "./validation/paths";
