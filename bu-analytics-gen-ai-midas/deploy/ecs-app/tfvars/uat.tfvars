# MIDAS EKS app - uat
# Use: terraform plan -var-file=tfvars/uat.tfvars

aws_account_id         = "811391286931"
terraform_state_bucket = "midas-uat-us-east-1-terraform-811391286931"
environment            = "uat"
...
# Optional Windows SSM test VM; keep false in shared tiers unless needed.
...
# Update this value when the UAT certificate domain is confirmed.
alb_nlb_certificate_arn = "" # Set to the ACM certificate ARN once imported for UAT
